...
function indexTickets()
{
    ...
    switch ($_SESSION["rol"]) {
        case 'admin':
            $sql = "SELECT t.*, c.nombre AS nombre_area FROM tickets t INNER JOIN cat_areas c ON t.area_id = c.id_area;";
            break;
        case 'tecnico':
            $sql = "SELECT t.*, c.nombre AS nombre_area FROM tickets t INNER JOIN cat_areas c ON t.area_id = c.id_area where tecnico_id = '{$_SESSION['id']}'";
            break;
        case 'usuario':
            $sql = "SELECT t.*, c.nombre AS nombre_area FROM tickets t INNER JOIN cat_areas c ON t.area_id = c.id_area where area = '{$_SESSION['usuario']}'";
            break;
    }
